...
city_recipients = {
    'blr': {'to': ['kartik@project-lithium.com'], 'cc': ['kartikpande12@gmail.com'], 'query_name': 'blr'},
    'ncr': {
    ...
    'pnq': {'to': ['kartik@project-lithium.com'], 'cc': ['kartikpande12@gmail.com'], 'query_name': 'pnq'},
    'mum': {'to': ['kartik@project-lithium.com'], 'cc': ['kartikpande12@gmail.com'], 'query_name': 'mum'},
    'chn': {'to': ['kartik@project-lithium.com'], 'cc': ['kartikpande12@gmail.com'], 'query_name': 'chn'},
    'hyd': {'to': ['kartik@project-lithium.com'], 'cc': ['kartikpande12@gmail.com'], 'query_name': 'hyd'},
}
